...
namespace Sondage
{
    ...
    {
        /// The _instance
        private static volatile SimpleSondageDAO _instance;
        ...
        /// The instance.
        /// </value>
        public static SimpleSondageDAO Instance
        {
            get
            {
                if (_instance == null)
                {
                    lock (_syncRoot)
                    {
                        if (_instance == null)
                        {
                            _instance = new SimpleSondageDAO();
                        }
                    }
                }
                return _instance;
